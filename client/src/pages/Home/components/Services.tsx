...
export default function Services() {
	return (
		<section id="services" className=" w-full min-h-screen bg-service-pattern bg-cover bg-fixed max-lg:bg-center max-sm:bg-center p-20">
					...
					{services.map((val) => (
						<div key={val.label} className=" relative group bg-white min-h-[350px] pt-20 pb-9 text-center flex flex-col items-center justify-center max-xl:pt-16">
							<div>
								...
								<p className="px-12 font text-lg pb-16 max-xl:px-5">{val.desc}</p>
							</div>
