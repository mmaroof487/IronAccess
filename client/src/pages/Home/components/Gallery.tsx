...
export default function Gallery() {
	return (
		<section
			id="gallery"
			className=" min-h-screen px-20 w-full grid grid-cols-4 grid-rows-2 gap-7 max-lg:grid-cols-2 max-lg:grid-rows-4 max-lg:gap-4 max-sm:grid-cols-1 max-sm:grid-rows-5 max-sm:gap-x-0">
