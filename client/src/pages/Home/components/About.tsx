...
export default function About() {
	return (
		<section id="about" className="max-w-screen min-h-screen">
			<div className=" max-container flex justify-center items-center gap-24 padding-hero-y padding-x h-full max-xl:gap-7 max-lg:flex-col">
				...
				<div className=" flex-1">
					...
					<p className="font text-lg text-slate-800">
						Brook presents your services with flexible, convenient and cdpose layouts. You can select your favorite layouts & elements for cular ts with unlimited ustomization possibilities. Pixel-perfect
